...
<div class="container">
    <a class="navbar-brand boton-volver" href="directorio.php?dir=<?php echo $dir ?>">Volver a /<?php echo $dir ?></a>
  </div>
</nav>
    ...
    ?>
    <textarea disabled name="valor-nota" style="height: 500px;" class="valor-nota w-75 d-block mx-auto m-4 shadow-sm bg-body rounded" id="" cols="30" rows="10"><?php echo $contents; ?></textarea>
</body>
